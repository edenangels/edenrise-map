...
function onMovePreview(e){ if(!anchor) return; const azd=azTo(anchor,e.latlng); const c=centreFrom(anchor,azd); const keep=SH.rot; SH.rot=azd; if(preview) map.removeLayer(preview); preview=buildShape(c,{dashArray:"6 5",fillOpacity:.08,interactive:false}); preview.addTo(map); SH.rot=keep;
